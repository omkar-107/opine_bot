  ...
  // import opinebotImage from "../public/images/opinebot.png";
  ...
  export const LampContainer = ({
    ...
    return (
      <div
        className={cn(
          "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-screen", // Changed to w-screen for full width
          className
        )}
      >
        <div
          ...
          <motion.div
            ...
            <div
              className="absolute  w-40 h-[100%] left-0 bg-slate-950  bottom-0 z-30 [mask-image:linear-gradient(to_right,white,transparent)]" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0.5, width: "15rem" }}
            whileInView={{ opacity: 1, width: "30rem" }}
            ...
            <div
              className="absolute  w-[100%] right-0 bg-slate-950 h-40 bottom-0 z-30 [mask-image:linear-gradient(to_top,white,transparent)]" />
          </motion.div>
          <div
