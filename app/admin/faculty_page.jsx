...
import { Building2, Search, UserCircle2, BookOpen, Users, GraduationCap, Plus, School } from 'lucide-react';
              ...
              <div className="bg-blue-50 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-600">{faculties.length}</p>
                  </div>
                </div>
              </div>
            ...
            <Dialog open={isAddFacultyDialogOpen} onOpenChange={setIsAddFacultyDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden rounded-2xl">
                <DialogHeader className="p-6 bg-gradient-to-r from-blue-600 to-indigo-600">
                  <DialogTitle className="text-xl font-semibold text-white">Add New Faculty</DialogTitle>
                </DialogHeader>
                <div className="p-6 space-y-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      {["Computer Science", "Engineering", "Mathematics", "Physics"].map((dept) => (
                  ...
                  <Button
                    ...
                    disabled={!newFaculty.username || !newFaculty.department || !newFaculty.password}
          ...
          <CardContent className="p-0">
            ...
            <div className="divide-y">
              {filteredFaculties.map((faculty) => (
                <div key={faculty.username} className="grid grid-cols-6 gap-4 p-4 items-center hover:bg-blue-50 transition-colors duration-200">
                  ...
                  <div className="flex justify-end">
                    <Dialog 
                      open={isAssignDialogOpen && selectedFaculty?.username === faculty.username}
                      onOpenChange={(open) => {
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden rounded-2xl">
                        ...
                        <div className="p-6 space-y-4">
                          <Select
                            onValueChange={(value) => {
                              const course = courses.find(c => c.id_ === value);
                          ...
                          >
                            ...
                            <SelectContent>
                              {courses
                                .filter(course => !(faculty.faculty_courses || []).includes(course.id_))
                                .map((course) => (
