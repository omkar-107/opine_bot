          ...
          <section className="flex flex-col md:flex-row justify-between w-full px-4 sm:px-6 md:px-10 lg:px-16 py-8 md:py-12 bg-violet-200">
            <div className='flex flex-col justify-center md:mx-0 lg:mx-8 max-w-xl'>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-2">
                <a href="/login" className="flex items-center justify-center bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 shadow-md text-base sm:text-lg font-medium">
                  Get Started
          ...
          <section className="py-12 md:py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white w-full">
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto">
                <a href="/loginp" className="bg-white text-blue-600 hover:bg-blue-50 py-3 px-8 rounded-lg shadow-lg transition-all duration-300 font-semibold text-base md:text-lg flex items-center justify-center">
