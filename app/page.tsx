...
// Import the specific types if available
import { Typography } from "@material-tailwind/react";

// Create a simple navbar div instead of using Material Tailwind's Navbar
const SimpleNavbar = ({
  className,
  children,
}: {
...
export default function LandingPage() {
  ...
  const getColorClass = (prefix: string, color: string) => {
    ...
    const safeColor = safeColors[color] || "blue";
    return `${prefix}-${safeColor}`;
  };

  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full overflow-x-hidden">
      {/* Responsive Navbar - Using a simple div instead of Material Tailwind Navbar */}
      <SimpleNavbar className="sticky top-0 z-10 h-max w-full max-w-full rounded-none px-4 py-2 lg:px-8 shadow-md">
            ...
            {howItWorks.map((step, index) => (
              ...
              >
                ...
                <div
                  ...
                  bg-white flex items-center justify-center mr-4 md:mr-6
