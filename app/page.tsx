...
import CustomNavbar from "../components/ui/navbar"; // Local navbar component
...
// Only import Typography from material-tailwind
import { Typography, Button } from "@material-tailwind/react";

const navList = (
  <ul className="mt-20 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6"></ul>
);
...
const benefits = [
  {
    ...
    description:
      "AI-powered analysis provides deeper understanding of student feedback",
...
const howItWorks = [
  {
    ...
    description:
      "Start a conversation with our AI-powered feedback system that adapts to your responses",
  ...
  },
  {
    ...
    description:
      "Our system analyzes your feedback using advanced natural language processing",
  ...
  },
  {
    ...
    description:
      "Transform raw feedback into actionable insights and recommendations",
  ...
  },
  {
    ...
    description:
      "Implement changes based on feedback and monitor progress over time",
...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full overflow-x-hidden">
      {/* Responsive Navbar - Using custom HTML instead of Material Tailwind Navbar */}
      <header className="sticky top-0 z-10 w-full bg-white shadow-md">
        <div className="container mx-auto px-4 py-2 lg:px-8">
          <div className="flex items-center justify-between text-blue-gray-900">
            {/* Fixed: Replaced Typography with an anchor tag */}
            <a
              href="#"
            ...
            <div className="hidden md:flex items-center space-x-4 ml-auto">
              <a
                href="/login"
                className="flex items-center px-4 py-2 text-blue-600 border border-blue-600 rounded-full hover:bg-blue-50 transition-colors duration-300"
              >
              ...
              <a
                href="/signup"
                className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors duration-300 shadow-md hover:shadow-lg"
              >
      ...
      <section className="flex flex-col md:flex-row justify-between w-full px-4 sm:px-6 md:px-10 lg:px-16 py-8 md:py-12 bg-violet-200">
        <div className="flex flex-col justify-center md:mx-0 lg:mx-8 max-w-xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 md:mb-8">
            Transform your course feedback with AI-powered conversations that
            engage students and provide deeper insights.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <a
              href="/signup"
              className="flex items-center justify-center bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 shadow-md text-base sm:text-lg font-medium"
            >
              Get Started
            ...
            <a
              href="#how-it-works"
              className="flex items-center justify-center bg-white text-blue-600 py-3 px-6 rounded-lg border border-blue-600 hover:bg-blue-50 transition-colors duration-300 text-base sm:text-lg font-medium"
            >
              Learn More
            </a>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <Tabs defaultValue="students" className="max-w-4xl mx-auto">
            ...
            {[
              ...
              >
                <Card
                  className="px-4 sm:px-6 md:px-8 py-4 md:py-6 w-full bg-white shadow-lg rounded-xl
                  ...
                  <CardContent className="p-4 md:p-8">
                    ...
                    <div className="grid gap-4 md:gap-6">
                      {content.features.map((feature, index) => (
                        ...
                        >
                          <CheckCircle
                            className="w-5 h-5 md:w-6 md:h-6 text-purple-500 transition-transform duration-300 
      ...
      <section
        id="how-it-works"
        className="py-8 md:py-10 bg-gradient-to-b from-white to-gray-50 w-full"
      >
          ...
          <div className="max-w-4xl mx-auto relative">
            {howItWorks.map((step, index) => (
              ...
              >
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(180deg, 
                        ...
                        ${
                          howItWorks[index + 1].color === "blue"
                            ? "#DBEAFE"
                            : howItWorks[index + 1].color === "green"
                            ? "#DCFCE7"
                            : howItWorks[index + 1].color === "yellow"
                            ? "#FEF9C3"
                            : "#E9D5FF"
                        } 100%)`,
                    }}
                ...
                <div
                  ...
                  border-2 ${
                    step.color === "blue"
                      ...
                      : step.color === "yellow"
                      ? "border-yellow-200 group-hover:border-yellow-400"
                ...
                {/* Content container */}
                <div
                  className="flex-grow transform transition-all duration-300 ease-in-out
                  translate-y-0 group-hover:-translate-y-1"
                >
                  <div
                    className="bg-white p-3 sm:p-4 md:p-6 rounded-xl shadow-sm
                  ...
                  >
                    ...
                    <p
                      className="text-sm sm:text-base text-gray-600 group-hover:text-gray-700
                      transition-colors duration-300"
                    >
                      {step.description}
                    </p>
              ...
              <div key={index} className="group">
                <Card className="h-full transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                  <CardContent className="p-4 sm:p-6 md:p-8">
                    <div
                      className={`w-12 h-12 md:w-16 md:h-16 rounded-2xl mb-4 md:mb-6 flex items-center justify-center bg-gradient-to-r ${benefit.gradient} transform transition-transform group-hover:scale-110`}
                    >
      ...
      <section className="py-12 md:py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white w-full">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto">
            <a
              href="/signup"
              className="bg-white text-blue-600 hover:bg-blue-50 py-3 px-8 rounded-lg shadow-lg transition-all duration-300 font-semibold text-base md:text-lg flex items-center justify-center"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              {/* Fixed: Replaced Typography component with a regular heading */}
